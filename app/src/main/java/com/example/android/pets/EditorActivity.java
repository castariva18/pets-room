...
public class EditorActivity extends AppCompatActivity {
    ...
    /**
     * Gender for PET; 0-UNKNOWN; 1-MALE; 2-FEMALE
     */
    ...
    private void savePet() {
        ...
        if (currentPet == null) {
            ...
            PetEntity entity = new PetEntity(mNameEditText.getText().toString(),
                    mBreedEditText.getText().toString(),
                    mGender,Integer.parseInt(mWeightEditText.getText().toString()));
            PetDb.getInstance(this).getDao().insert(entity);
        } else {
            ...
            currentPet.setName(mNameEditText.getText().toString());
            currentPet.setBreed(mBreedEditText.getText().toString());
            currentPet.setGender(mGender);
            currentPet.setWeight(Integer.parseInt(mWeightEditText.getText().toString()));
            PetDb.getInstance(this).getDao().update(currentPet);
    ...
    private void deletePet() {
        ...
        //TODO: perform delete
        PetDb.getInstance(this).getDao().delete(currentPet);
